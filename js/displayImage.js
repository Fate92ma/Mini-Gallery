...
let displayImage = document.getElementsByClassName('displayImage')[0],
...
function isImageFound() {
    ...
    if (getSavedImageId) {
        ...
        // display its data
        myDisplayImage(singleObject, displayImage)
    ...
    // if no id found
        ...
        displayImage.innerHTML = `<center>Click On Any Image To View In This Page</center>`
...
function myDisplayImage(object, whereToShow) {

    whereToShow.innerHTML =

    `<img src="${object.largeImageURL}" alt="image">
